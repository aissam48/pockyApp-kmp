...
object Constant {
    val set = "env"
    val DEV_ENV = "http://192.168.100.127:443/api/v1"
    val PROD_ENV = "https://pockyappbackend.onrender.com/api/v1"

    val DEV_ENV_HOST = "192.168.100.127:443"
    val PROD_ENV_HOST = "pockyappbackend.onrender.com"



    var SHARED_LINK = PROD_ENV
    var SHARED_LINK_HOST = PROD_ENV_HOST

    val ws = "wss://$SHARED_LINK_HOST/ws"
